  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {isOpen && (
        <div
          data-wj-exit
          className="fixed sm:absolute right-2 sm:right-0 top-16 sm:top-auto sm:mt-2 w-[94vw] sm:w-[460px] bg-white rounded-2xl shadow-2xl border border-slate-200 z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150 text-xs max-h-[85dvh] flex flex-col"
        >
